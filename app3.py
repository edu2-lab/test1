...
# ── 1. 수업 제목 ──
st.title("집 가고 싶어.")  # ← 교과별 제목으로 자유롭게 수정하세요.
...
# ── 3‑3. 서술형 문제 3 표시 ──
QUESTION_3 = """
기체의 압력이 증가할 때, 기체 입자의 빠르기는 어떻게 될까요?
"""
...
GRADING_GUIDELINES = {
    1: "기체 부피는 감소한다.",
    2: "일정한 온도에서, 기체의 압력과 부피는 반비례한다.",
    3: "기체의 압력이 증가해도, 기체 입자의 빠르기는 변하지 않는다(일정하다)."
}
